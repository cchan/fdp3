...
\section{Safety}
\subsection{Embedded \& Communication Systems}
\subsubsection{Pre-launch Tests}
\begin{table}[H]
	\centering
...
\end{table}
    ...
    \subsubsection {Failure scenarios and state diagram}
  ...
  The software failure state diagram \reffig{fig:pod-failure-state-diagram} shows the behaviour and flow of the control systems. In addition, \reftlb{tlb:fail-table} shows all of the possible failure scenarios and according software actions that are taken as a consequence.\\
...
\end{figure}
    ...
    To summarize all of the hardware elements of the Embedded-systems \reffig{} lists all of the components described in sections above.
