...
In the lateral load case, a global acceleration of \SI{10}{m/s} laterally was added. The wheel was fixed in the vertical direction, and the frame contact points were fixed in the three longitudinal directions. The solve gave a maximum stress of \SI{123}{MPa} on a motor mounting screw and a minimum safety factor of 2.61. A maximum displacement of \SI{1.5}{mm} was generated.
...
\begin{figure}
    ...
    \begin{figure}
        ...
        \caption{FEA mesh on wheel}
        \label{fig:mesh}
    \end{figure}
    The mesh (\reffig{fig:mesh}) was created with an average element size of 2\% of the model based size had a parabolic element order. To refine our mesh and create more accurate results, adaptive mesh refinement was done in the areas of peak stress, at a cycle of 6 mesh refinements with a convergence tolerance of 5\%.
