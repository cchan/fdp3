...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \caption{This plot is similar to \reffig{fig:RandDistToRail} except that the arrangement of the rail in this simulation is in alternating order. Again we can see that the closest the pod will get to the rail in less then 12mm }
    \end{figure}
