...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \caption{This plot is similar to \reffig{fig:RandDistToRail} except the the arrangement of the rail in this simulation is not in a random order, they are oscillating. Again we can see that the closest the pod will get to the rail in less then 12mm }
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \caption{This simulation was done to show how the pod will respond to a rail. In this case the rail in placed in random order.}
    \end{figure}
    \begin{figure}[H]
    	\centering
        \includegraphics[width=\linewidth]{images/OscillatingPodLateralResponse}
        \label{fig:OPodLateralRespnse}
        \caption{This simulation was done to show how the pod will respond to a rail. The rail will be oscillating.}
    \end{figure}    
