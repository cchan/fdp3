...
\begin{document}
    ...
    \begin{figure}
        ...
        \caption{This plot is similar to Figure 5.2\reffig{fig:RandDistToRail} except that the arrangement of the rail in this simulation is in alternating order. The closest distance is again 12mm.}
    \end{figure}
    \begin{figure}[H]
    	\centering
