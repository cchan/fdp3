...
\begin{document}
    ...
    \end{figure}
    The overall brakes can be seen in \reffig{fig:EC-Assembly}. The piston is mounted to the frame through our piston mount which is attached to the magnet bar The way the brakes actuates 
    \begin{figure}
    	\centering
