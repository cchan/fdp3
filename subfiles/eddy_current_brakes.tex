...
\begin{document}
    ...
    \end{figure}
    The overall brakes can be seen in \reffig{fig:EC-Assembly}. The piston is mounted to the frame through our piston mount which is attached to the magnet bar. and the magnet bar will be moving in a linear direction given by the shaft.
    \begin{figure}
    	\centering
    ...
    \end{figure}
    Above we have FEA for each specific component of the brakes that will be experiencing large forces. 
