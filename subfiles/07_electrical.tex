...
\begin{document}
    ...
    To achieve a voltage of 567V the main battery (see \reftab{tab:main-bat-specs} for specifications) will be an assembly of 27 modules (see \reftab{tab:module-specs} for specifications and \reffig{fig:module-model} for model). Each module houses 5 LiPo cells giving a total of 135 cells.\\
    ...
    Each cell (see \reftab{tab:cell-specs} for specifications% and \reffig{fig:cell-model} for model
